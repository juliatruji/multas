...
%>
<%
    VehiculosDTO[] obj_vehiculo = (VehiculosDTO[]) session.getAttribute("vehiculos");
            ...
            <div class="container-login100" style="background-image: url('./assets/images/bg-02.jpg');">
                ...
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form">
                        <span class="login100-form-title p-b-18 p-t-0">Lista de Vehículos
                        </span>
                        <div class="container-fluid">
                            <div class="row">
                                <table class="table table-striped table-hover table-dark text-center">
                                    ...
                                    <tbody>
                                        <% for (int i = 0; i < obj_vehiculo.length; i++) {
                                        %>
                                        <tr>
                                            <td><% out.println(obj_vehiculo[i].getMarcatext()); %></td>
                                            <td><% out.println(obj_vehiculo[i].getModelo()); %></td>
                                            <td><% out.println(obj_vehiculo[i].getColor()); %></td>
                                            <td><% out.println(obj_vehiculo[i].getPlaca()); %></td>
                                            <td><% out.println(obj_vehiculo[i].getDni()); %></td>
                                        </tr>
