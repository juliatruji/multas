...
<html>
    <head>
        <title>Registro de Códigos de Multas</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <form id="formulariocodmultas" class="formulario" action="RegistroCodMultas" method="POST">
            <h1>Registro de Códigos de Multas de Tránsito</h1>
            <div>
                <label for="codfalta">Código de la falta:</label>
                <input type="text" id="codfalta" name="codfalta" placeholder="Código de falta"/>

            </div>
            <div>
                <label for="descripcion">Descripción:</label>
                <textarea id="descripcion" name="descripcion" placeholder="Descripción de la Falta"></textarea>
            </div>
            ...
            <div class="doblecolumna">
                <div>
                    <label for="montouit">Monto en UIT </label>
                    <input type="number" id="montouit" name="montouit" placeholder="Porcentaje de UIT"/>
                </div>
                <div>
                    <label for="puntos">Puntos</label>
                    <input type="number" id="puntos" name="puntos" placeholder="Puntos de Licencia"/>
                </div>
            </div>

            <div>
                <label for="medidapreventiva">Sancion</label>
            ...
            <div>
                ...
                <select name="medidapreventiva" id="medidapreventiva">
            ...
            <div class="doblecolumna">
                <div><button id="registrarcodmultas" type="submit">Registrar
                    </button>
                </div>
