...
<%
    ...
    String dnipolicia = currentUser.getDni();
%>
<!DOCTYPE html>
<html lang="es">
...
<!--							<a class="dropdown-item" href="/FormPolicias.jsp"><i class="zmdi zmdi-plus-square"></i> Agregar Multa</a>
							<a class="dropdown-item" href="/FormConductores.jsp"><i class="zmdi zmdi-plus-square"></i> Agregar Conductor</a>-->
							<a class="dropdown-item" href="/FormMultas.jsp"><i class="zmdi zmdi-code"></i> Agregar Multa</a>
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<span class="login100-form-title p-b-34 p-t-27">
							<i class="zmdi zmdi-account"></i> Bienvenid@ Policía
					</span>
                                        <span class="login100-form-title p-b-34 p-t-27">
                                                <%= nombrepolicia %> <%= apellidospolicia %>
					</span>
