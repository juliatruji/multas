...
%>
<%
    MisMultasDTO[] obj_multa = (MisMultasDTO[]) session.getAttribute("multas");
            ...
            <div class="container-login100" style="background-image: url('./assets/images/bg-02.jpg');">
                ...
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form">
                        <span class="login100-form-title p-b-18 p-t-0">Lista de Multas 
                        </span>
                        <div class="container-fluid">
                            <div class="row">
                                <table class="table table-striped table-hover table-dark text-center">
                                    ...
                                    <tbody>
                                        <% for (int i = 0; i < obj_multa.length; i++) {
                                        %>
                                        <tr>
                                            <td><% out.println(obj_multa[i].getCod_falta()); %></td>

                                            <td class="desclarga" data-toggle="tooltip" data-placement="top" title="<% out.println(obj_multa[i].getDescripcion().toString()); %>">
                                                <% out.println(obj_multa[i].getDescripcion().toString()); %>
                                            </td>

                                            <td><% out.println(obj_multa[i].getMonto_uit()); %></td>
                                            <td><% out.println(obj_multa[i].getFecha()); %></td>
                                            <td><% out.println(obj_multa[i].getPlaca()); %></td>
                                            <td><% out.println(obj_multa[i].getDepartamento()); %></td>
                                            <td><% out.println(obj_multa[i].getObs_conductor()); %></td>
                                            <td><% out.println(obj_multa[i].getObs_polocia()); %></td>
                                            <td><% out.println(obj_multa[i].getNombre_policia() + " " + obj_multa[i].getApellido_policia()); %></td>
                                            <td><% out.println(obj_multa[i].getCod_cip()); %></td>
                                        </tr>
