...
%>
<%
    ConductorDTO[] obj_conductores = (ConductorDTO[]) session.getAttribute("conductores");
            ...
            <div class="container-login100" style="background-image: url('./assets/images/bg-02.jpg');">
                ...
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form">
                        <span class="login100-form-title p-b-18 p-t-0">Lista de Conductores
                        </span>
                        <div class="container-fluid">
                            <div class="row">
                                <table class="table table-striped table-hover table-dark text-center">
                                    ...
                                    <tbody>
                                        <% for (int i = 0; i < obj_conductores.length; i++) {
                                        %>
                                        <tr>
                                            <td><% out.println(obj_conductores[i].getNombres()); %></td>
                                            <td><% out.println(obj_conductores[i].getApellidos()); %></td>
                                            <td><% out.println(obj_conductores[i].getDni()); %></td>
                                            <td><% out.println(obj_conductores[i].getNlicencia()); %></td>
                                            <td><% out.println(obj_conductores[i].getClaselicencia()); %></td>
                                            <td><% out.println(obj_conductores[i].getCategorialicencia()); %></td>
                                        </tr>
